...
const MainContent = () => {
    ...
    useEffect(() => {
        trackPageView('account_page', walletAddress || undefined);
    }, [walletAddress]);
            ...
            <div className="fixed inset-0 flex flex-col h-screen overflow-hidden z-50">
                ...
                <div className="flex-1 flex flex-col min-h-0 gap-4">
                    ...
                    <div className="flex-shrink-0 px-4 pt-4">
                        <Header onAccountClick={handleAccountClick} showHomeButton={true} />
                    </div>
                    {/* QR Code Section */}
...
export const AccountPage = (_props?: AccountPageProps) => {
    return <MainContent />;
};
