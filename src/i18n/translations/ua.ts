...
export const ua: TranslationKey = {
    ...
    onboarding: {
        discover: {
            title: 'Відкрийте благодійність',
            subtitle: 'Знайдіть справи, які вам важливі',
            description: 'Переглядайте перевірені благодійні організації та знаходьте ті, що роблять реальні зміни у світі.',
        },
        donate: {
            title: 'Зробіть внесок',
            subtitle: 'Допомагайте легко',
            description: 'Підтримуйте обрані благодійні організації безпечними миттєвими донатами — кожен внесок важливий.',
        },
        track: {
            title: 'Відстежуйте допомогу',
            subtitle: 'Бачте свій вплив',
            description: 'Стежте за прогресом благодійних організацій та дивіться, як ваші донати допомагають досягати важливих цілей.',
        },
